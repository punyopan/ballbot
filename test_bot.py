...
def test_decide_prefers_goal_over_gyro():
    ...
    vx, vy, w, kick = decide((0.0, close), 60.0, None, {}, goal=(0.0, 40))
    assert kick and vx > 0.5, "goal centred in frame: charge despite gyro disagreeing"
    ...
    vx, vy, w, kick = decide((0.0, close), 0.0, None, {}, goal=(0.5, 40))
